                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                    <a href="{{ route('admin.account.add') }}" class="btn btn-danger mb-2">
                                        <i class="mdi mdi-plus-circle me-2"></i> Thêm quản trị
                                    </a>
                                </div>
                                <div class="col-sm-7">
...
@section('script')
    <script>
        ...
        $('#submit-delete').on('click', function(e) {
            ...
            let routeDelete = `{{ route('admin.account.delete') }}`
            $.ajax({
                type: 'POST',
                url: routeDelete,
                processData: false,
        ...
        $('body').on('change', '.update-status', function() {
            $.ajax({
                type: 'POST',
                url: `{{ route('admin.account.updateStatus') }}`,
                data: {
