                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Cập nhật quản trị</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Cập nhật quản trị</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="custom-styles-preview">
                                    <form id="form-update" class="needs-validation" novalidate>
                                        ...
                                        <input type="hidden" name="id" id="id_update" value="{{ $user->id }}">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    <div class="row">
                                                        ...
                                                        @php
                                                            $avatar = $user->avatar ? asset($user->avatar) : asset('assets/systems/avatar-default.jpg');
                                                        @endphp
                                                        <div class="col-sm-6">
                                                            <img 
                                                                id="preview-avatar"
                                                                src="{{ $avatar }}"
                                                                alt="{{ $user->full_name }}" class="img-fluid avatar-lg rounded-circle"
                                                            >
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#district').empty();
                    let userDistrictId = '{{ $user->district_id }}';
                    let selected = '';
        ...
        $('#submit-update').click(function(e) {
            ...
            let route = `{{ route('admin.account.update') }}`
            $.ajax({
                type: 'POST',
                url: route,
                processData: false,
