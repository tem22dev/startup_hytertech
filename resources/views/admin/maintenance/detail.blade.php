                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li><i class="mx-2 fas fa-chevron-right"></i></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Cập nhật thông tin</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Thông tin bảo trì [tên giàn]</h4>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-xl-6" data-select2-id="select2-data-6-d7og">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" data-toggle="select2" data-select2-id="select2-data-1-t3ui" tabindex="-1" aria-hidden="true">
                                            <option data-select2-id="select">Select</option>
                                            <option value="1" data-select2-id="station-1" selected>Giàn số 1</option>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea 
                                            ...
                                            id="project-overview" 
                                            rows="6" 
                                            placeholder="Nhập vào nội dung bảo trì">
                                            Bảo trì cảm biến giàn số 1
                                        </textarea>
                                    </div>
                                </div>
                                <div class="col-xl-12 text-end">
                                    <button type="button" class="btn btn-info" style="min-width: 150px;">Cập nhật</button>
                                </div>
                            </form>
                        </div>
                    </div>
